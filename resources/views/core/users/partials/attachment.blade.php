<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-50">
            <h2 class="text-lg font-bold text-gray-900">Attachment</h2>
            <p class="text-sm text-gray-400">Dokumen pendukung pengguna.</p>
        </div>
        <div class="p-6">
            <p class="text-gray-500 italic text-center py-8">Belum ada fitur attachment.</p>
        </div>
