...
class SalesCustomersController extends Controller
{
    public function index(Request $r)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat customers', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function store(Request $r)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal membuat customer', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function show(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat customer', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function update(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memperbarui customer', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function destroy(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal menghapus customer', 500, 'SERVER_ERROR');
        }
    }
}
