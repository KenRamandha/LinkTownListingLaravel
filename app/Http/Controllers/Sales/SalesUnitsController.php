...
class SalesUnitsController extends Controller
{
    public function indexByProperty(Request $r, string $propertyId)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat units', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function storeForProperty(Request $r, string $propertyId)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal membuat unit', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function update(Request $r, string $unitId)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memperbarui unit', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function destroy(Request $r, string $unitId)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal menghapus unit', 500, 'SERVER_ERROR');
        }
    }
}
