...
class SalesListingsController extends Controller
{
    ...
    public function store(Request $r)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal membuat listing', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function show(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat listing', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function update(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memperbarui listing', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function destroy(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal menghapus listing', 500, 'SERVER_ERROR');
        }
    }
}
