...
class SalesPropertiesController extends Controller
{
    public function index(Request $r)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat properties', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function store(Request $r)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal membuat property', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function show(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memuat property', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function update(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal memperbarui property', 500, 'SERVER_ERROR');
        }
    }
    ...
    public function destroy(Request $r, string $id)
    {
        try {
            ...
            report($e);
            return $this->fail('Gagal menghapus property', 500, 'SERVER_ERROR');
        }
    }
}
