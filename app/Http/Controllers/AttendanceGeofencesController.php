...
class AttendanceGeofencesController extends Controller
{
    public function index(Request $r)
    {
        ...
        } catch (Throwable $e) { report($e); return $this->fail('Gagal memuat geofences',500,'SERVER_ERROR'); }
    }
    ...
    public function store(Request $r)
    {
        ...
        catch (Throwable $e) { report($e); return $this->fail('Gagal membuat geofence',500,'SERVER_ERROR'); }
    }
    ...
    public function update(Request $r, string $id)
    {
        ...
        catch (Throwable $e) { report($e); return $this->fail('Gagal memperbarui geofence',500,'SERVER_ERROR'); }
    }
    ...
    public function destroy(Request $r, string $id)
    {
        ...
        } catch (Throwable $e) { report($e); return $this->fail('Gagal menghapus geofence',500,'SERVER_ERROR'); }
    }
}
